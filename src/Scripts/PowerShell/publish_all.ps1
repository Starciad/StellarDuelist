...
$desktopGL = "..\src\StardustDefender\StardustDefender.DesktopGL.csproj"
$windowsDX = "..\src\StardustDefender\StardustDefender.WindowsDX.csproj"
...
$source = "..\src\StardustDefender\Content"
