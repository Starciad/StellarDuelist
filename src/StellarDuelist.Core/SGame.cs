...
#if PC
using StellarDuelist.CaptureSystem;
#endif

namespace StellarDuelist.Core
{
    /// <summary>
    /// Responsible for containing the main components for the standardized and complete initialization of StellarDuelist.
    /// </summary>
    /// <remarks>
